...
[seriesInfo]
name = "Internet-Draft"
value = "draft-ietf-scim-interop-profile-00"
stream = "IETF"
status = "standard"
...
## 4.4. Attribute and Schema Handling
...
## 4.5. Canonical Values for Typed Attributes
...
# 5. Protocol and Endpoint Requirements

## 5.1. Data Format and HTTP Headers
...
### 5.3.1. General PATCH Constraints

#### 5.4.1.1. Mandatory Use of the 'path' Attribute
...
#### 5.4.1.2. Multi-Attribute Updates
...
### 5.3.2. Attribute-Specific Requirements

#### 5.4.2.1. Singular Attributes (Simple and Complex)
...
#### 5.4.2.2. Multi-valued Attributes (Simple and Complex)
...
## 5.6. Concurrency and Versioning
